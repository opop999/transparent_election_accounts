...
for (i in seq.int(from = 0, to = 250, by = 50)) {
  
  new_lines <- fromJSON(content(GET(url = paste0("https://www.kb.cz/transparentsapi/transactions/1153902720297?skip=", i)), as = "text"))[[2]]
...
saveRDS(full_df, "temp/soukromnici_donation.rds")

full_df <- readRDS("data/temporary_manual_scrape/ano_2011_expense.rds")
...
fwrite(full_df_combined, "data/temporary_manual_scrape/csv/kscm_donation.csv")
